...
public class ResizeDemo {
    public static void main(String[] args)
    {
        ...
        for (int i = 0; i < removeColumns; i++) {
            ...
            System.out.println("Find Col: " + sw.elapsedTime() + " seconds.");
            sc.removeVerticalSeam(verticalSeam);
            System.out.println("Resize Col: " + sw.elapsedTime() + " seconds.");
        }

        for (int i = 0; i < removeRows; i++) {
            int[] horizontalSeam = sc.findHorizontalSeam();
            System.out.println("Find Row: " + sw.elapsedTime() + " seconds.");
            sc.removeHorizontalSeam(horizontalSeam);
            System.out.println("Resize Row: " + sw.elapsedTime() + " seconds.");
        }
