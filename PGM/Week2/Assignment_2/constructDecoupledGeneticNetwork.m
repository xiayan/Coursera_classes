...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for k = 1:numPeople
    parent1 = pedigree.parents(k, 1);
    parent2 = pedigree.parents(k, 2);
    if (parent1 == 0)
        factorList(k) = childCopyGivenFreqsFactor(alleleFreqs, k);
        factorList(k+numPeople) = childCopyGivenFreqsFactor(alleleFreqs, k+numPeople);
    else
        factorList(k) = childCopyGivenParentalsFactor(numAlleles, k, parent1, parent1+numPeople);
        factorList(k+numPeople) = childCopyGivenParentalsFactor(numAlleles, k+numPeople, parent2, parent2+numPeople);
    endif
endfor
