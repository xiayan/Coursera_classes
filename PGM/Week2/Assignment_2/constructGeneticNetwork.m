...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for k = 1:numPeople
    if (pedigree.parents(k,1) ~= 0)
        factorList(k) = genotypeGivenParentsGenotypesFactor(numAlleles, k, pedigree.parents(k,1), pedigree.parents(k,2));
    else
        factorList(k) = genotypeGivenAlleleFreqsFactor(alleleFreqs, k);
    endif
endfor

for m = numPeople+1 : 2 * numPeople
    factorList(m) = phenotypeGivenGenotypeFactor(alphaList, m - numPeople, m);
endfor
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%