...
phenotypeFactor.card = [2, size(alphaList)];
value = zeros(1, prod(phenotypeFactor.card));
betaList = 1 .- alphaList;
total = prod(phenotypeFactor.card);
phenotypeFactor.val = zeros(1, total);
phenotypeFactor.val(:, 1:2:total) = alphaList;
phenotypeFactor.val(:, 2:2:total) = betaList;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%